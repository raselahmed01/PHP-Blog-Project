            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        while ($all_blog_data=mysqli_fetch_assoc($all_blog_qry)) {
                        	?>
                        <div class="col-lg-6">
                        	<div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="<?php echo $all_blog_data['article_image'];?>" style="object-fit: cover;">
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        <a href=""><?php echo $all_blog_data['category_name'];?></a>
                                        
                                    </div>
                                    <a class="h4" href="single_blog.php?id=<?php echo $tag_blog_data['id'];?>"><?php echo $all_blog_data['title'];?></a>
                                    <p class="m-0"><?php echo substr_replace($all_blog_data['article'], '.....', 70);?></p>
                                </div>
                            </div>
                        </div>
                        <?php
                            ...
                            <nav aria-label="Page navigation">
                              <ul class="pagination justify-content-center">
                                ...
                                <?php 
                                	...
                                	$p_select="select * from article";
                                	$p_qry=mysqli_query($conn,$p_select);

                                	if(mysqli_num_rows($p_qry)>0){

                                		$total_records=mysqli_num_rows($p_qry);
