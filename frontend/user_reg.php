      ...
      <div class="card-body">
        <form method="post">
          ...
          <div class="input-group form-group">
            ...
            <input type="password" name="c_password" class="form-control" placeholder="User Confirm password">
          </div>
...
if(isset($_POST['signup'])){
  ...
  if($password == $c_password){
    ...
    $emailsel="select * from user_auth where email='$email' ";

    $qry=mysqli_query($conn,$emailsel);
    ...
    if($emailchk== 0){
      ...
      if($password_len>=8){
        ...
        $ins = "insert into user_auth (name,email,password) VALUES ('$name','$email','$hashpassword')";
