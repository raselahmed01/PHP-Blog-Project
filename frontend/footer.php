        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.php" class="navbar-brand">
                    <h3 class="mb-1 mt-n2 display-6  text-uppercase"><span class="text-primary">Blog</span>Project</h3>
                </a>
                ...
                <div class="d-flex flex-wrap m-n1">
                    <?php 
                        ...
                        while ($cateData=mysqli_fetch_assoc($cate_qry)) {
                            ?>
                    <a href="category_blog.php?category=<?php echo $cateData['id'];?>" class="btn btn-sm btn-outline-secondary m-1"><?php echo $cateData['category_name'];?></a>
                    <?php }?>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
